...
(self.webpackChunkwallet_connect = self.webpackChunkwallet_connect || []).push([[897], {
    91551: (t, e, r) => {
        "use strict";
        ...
        function I(t, e, r) {
            let i, n, s = 0, o = 0, a = 0, c = 0, h = 0, u = 0, l = 0, p = 0, f = 0, d = 0, g = 0, v = 0, y = 0, m = 0, w = 0, _ = 0, b = 0, E = 0, I = 0, P = 0, S = 0, O = 0, x = 0, C = 0, R = 0, A = 0, T = 0, N = 0, j = 0, L = 0, q = 0, D = r[0], M = r[1], z = r[2], k = r[3], $ = r[4], U = r[5], H = r[6], V = r[7], B = r[8], K = r[9], F = r[10], Z = r[11], W = r[12], G = r[13], J = r[14], Q = r[15];
            i = e[0],
            s += i * D,
            o += i * M,
            a += i * z,
        ...
        function q(t, e) {
            ...
            P(i, t[0]),
            I(i, i, s),
            w(i, n) ? -1 : (_(t[0]) === e[31] >> 7 && E(t[0], a, t[0]),
            I(t[3], t[0], t[1]),
            0)
        }
        e.Xx = function(t, e) {
    ...
    47227: (t, e, r) => {
            ...
            t.prototype.update = function(t, r) {
                ...
                this._bufferLength > 0) {
                    for (; this._bufferLength < e.BLOCK_SIZE && r > 0; )
                        this._buffer[this._bufferLength++] = t[i++],
                        r--;
                    this._bufferLength === this.blockSize && (a(this._tempHi, this._tempLo, this._stateHi, this._stateLo, this._buffer, 0, this.blockSize),
                    this._bufferLength = 0)
                }
                for (r >= this.blockSize && (i = a(this._tempHi, this._tempLo, this._stateHi, this._stateLo, t, i, r),
            ...
            t.prototype.finish = function(t) {
                if (!this._finished) {
                    ...
                    for (var c = r + 1; c < o - 8; c++)
                        this._buffer[c] = 0;
                    i.writeUint32BE(n, this._buffer, o - 8),
                ...
                for (c = 0; c < this.digestLength / 8; c++)
                    i.writeUint32BE(this._stateHi[c], t, 8 * c),
                    i.writeUint32BE(this._stateLo[c], t, 8 * c + 4);
                return this
            }
            ,
        ...
        function a(t, e, r, n, s, a, c) {
            for (var h, u, l, p, f, d, g, v, y = r[0], m = r[1], w = r[2], _ = r[3], b = r[4], E = r[5], I = r[6], P = r[7], S = n[0], O = n[1], x = n[2], C = n[3], R = n[4], A = n[5], T = n[6], N = n[7]; c >= 128; ) {
                for (var j = 0; j < 16; j++) {
                    var L = 8 * j + a;
                    t[j] = i.readUint32BE(s, L),
                    e[j] = i.readUint32BE(s, L + 4)
                }
                for (j = 0; j < 80; j++) {
                    var q, D, M = y, z = m, k = w, $ = _, U = b, H = E, V = I, B = S, K = O, F = x, Z = C, W = R, G = A, J = T;
                    if (f = 65535 & (u = N),
                    d = u >>> 16,
                    g = 65535 & (h = P),
                    v = h >>> 16,
                    f += 65535 & (u = (R >>> 14 | b << 18) ^ (R >>> 18 | b << 14) ^ (b >>> 9 | R << 23)),
                    d += u >>> 16,
                    g += 65535 & (h = (b >>> 14 | R << 18) ^ (b >>> 18 | R << 14) ^ (R >>> 9 | b << 23)),
                    v += h >>> 16,
                    f += 65535 & (u = R & A ^ ~R & T),
                    d += u >>> 16,
                    g += 65535 & (h = b & E ^ ~b & I),
                    ...
                    v += h >>> 16,
                    g += (d += (f += 65535 & u) >>> 16) >>> 16,
                    f = 65535 & (u = p = 65535 & f | d << 16),
                    d = u >>> 16,
                    g = 65535 & (h = l = 65535 & g | (v += g >>> 16) << 16),
                    v = h >>> 16,
                    f += 65535 & (u = (S >>> 28 | y << 4) ^ (y >>> 2 | S << 30) ^ (y >>> 7 | S << 25)),
                    d += u >>> 16,
                    g += 65535 & (h = (y >>> 28 | S << 4) ^ (S >>> 2 | y << 30) ^ (S >>> 7 | y << 25)),
                    v += h >>> 16,
                    d += (u = S & O ^ S & x ^ O & x) >>> 16,
                    g += 65535 & (h = y & m ^ y & w ^ m & w),
                    v += h >>> 16,
                    q = 65535 & (g += (d += (f += 65535 & u) >>> 16) >>> 16) | (v += g >>> 16) << 16,
                    D = 65535 & f | d << 16,
                    f = 65535 & (u = Z),
                    d = u >>> 16,
                    g = 65535 & (h = $),
                    ...
                    w = z,
                    _ = k,
                    b = $ = 65535 & (g += (d += (f += 65535 & u) >>> 16) >>> 16) | (v += g >>> 16) << 16,
                    E = U,
                    I = H,
                    P = V,
                    y = q,
                    ...
                    j % 16 === 15)
                        for (L = 0; L < 16; L++)
                            ...
                            v += h >>> 16,
                            l = t[(L + 1) % 16],
                            f += 65535 & (u = ((p = e[(L + 1) % 16]) >>> 1 | l << 31) ^ (p >>> 8 | l << 24) ^ (p >>> 7 | l << 25)),
                            d += u >>> 16,
                            g += 65535 & (h = (l >>> 1 | p << 31) ^ (l >>> 8 | p << 24) ^ l >>> 7),
                            v += h >>> 16,
                            l = t[(L + 14) % 16],
                            d += (u = ((p = e[(L + 14) % 16]) >>> 19 | l << 13) ^ (l >>> 29 | p << 3) ^ (p >>> 6 | l << 26)) >>> 16,
                            g += 65535 & (h = (l >>> 19 | p << 13) ^ (p >>> 29 | l << 3) ^ l >>> 6),
                            v += h >>> 16,
                            v += (g += (d += (f += 65535 & u) >>> 16) >>> 16) >>> 16,
                            t[L] = 65535 & g | v << 16,
                            e[L] = 65535 & f | d << 16
                }
                f = 65535 & (u = S),
    ...
    74180: (t, e, r) => {
        ...
        const i = r(73104);
        i.__exportStar(r(60786), e),
        i.__exportStar(r(66086), e)
    }
    ,
    69897: (t, e, r) => {
        "use strict";
        ...
        async function V(t, e, r, i) {
            ...
            (0,
            k.m)([$(c.header), $(c.payload)].join(x), A));
            var c;
            return function(t) {
                return [$(t.header), $(t.payload), (e = t.signature,
                (0,
                z.B)(e, C))].join(x);
                var e
            }({
        ...
        class wt extends ht {
            ...
            onPayload(t) {
                ...
                vt(t) ? this.events.emit(`${t.id}`, t) : this.events.emit("message", {
                    type: t.method,
                    data: t.params
                })
            }
        ...
        var St = function(t, e) {
            ...
            return {
                encode: function(e) {
                    ...
                    if (0 === e.length)
                        return "";
                    for (var r = 0, i = 0, n = 0, s = e.length; n !== s && 0 === e[n]; )
                        n++,
                        r++;
                    for (var o = (s - n) * u + 1 >>> 0, h = new Uint8Array(o); n !== s; ) {
                        for (var l = e[n], p = 0, f = o - 1; (0 !== l || p < i) && -1 !== f; f--,
                        p++)
                            l += 256 * h[f] >>> 0,
                            h[f] = l % a >>> 0,
                            l = l / a >>> 0;
        ...
        class Nt {
            constructor(t, e, r, i) {
                ...
                this.baseEncode = r,
                this.baseDecode = i,
                this.encoder = new Ct(t,e,r),
                this.decoder = new Rt(t,e,i)
            }
            encode(t) {
        ...
        const jt = t => {
          ...
          , Lt = t => {
            ...
            const {encode: n, decode: s} = Ot(i, r);
            return jt({
                prefix: e,
                name: r,
                encode: n,
        ...
        var Ie = function t(e, r) {
            var i, n = 0, s = 0, o = r = r || 0, a = e.length;
            do {
                if (o >= a)
                    throw t.bytes = 0,
                    new RangeError("Could not decode varint");
                i = e[o++],
                n += s < 28 ? (i & Se) << s : (i & Se) * Math.pow(2, s),
                s += 7
            } while (i >= Pe);
            return t.bytes = o - r,
            n
        ...
        class Ur {
            constructor(t, e) {
                ...
                this.get = t => {
                    ...
                    if (typeof e > "u") {
                        const {message: e} = (0,
                        s.Z7)("NO_MATCHING_KEY", `${this.name}: ${t}`);
                        throw new Error(e)
                    }
                    return e
                }
            ...
            constructor(t, e, r) {
                ...
                this.decode = async (t, e, r) => {
                    ...
                    try {
                        ...
                        this.logger.error(`Failed to decode message from topic: '${t}', clientId: '${await this.getClientId()}'`),
                        this.logger.error(l)
                    }
                }
                ,
                ...
                this.getPayloadSenderPublicKey = t => {
                    ...
                    B.BB)(e.senderPublicKey, s.AW) : void 0
                }
                ,
                this.core = t,
                this.logger = (0,
                c.generateChildLogger)(e, this.name),
                this.keychain = r || new Ur(this.core,this.logger)
            }
            get context() {
                return (0,
                c.getLoggerContext)(this.logger)
        ...
        class Br extends f {
            constructor(t, e) {
                ...
                this.publish = async (t, e, r) => {
                    ...
                    try {
                        ...
                        try {
                            await await (0,
                            s.hF)(this.rpcPublish(t, e, o, a, c, h, u), this.publishTimeout, "Failed to publish payload, please try again."),
                            ...
                            null != (i = null === r || void 0 === r ? void 0 : r.internal) && i.throwOnFailedPublish)
            ...
            rpcPublish(t, e, r, i, n, o, a) {
                ...
                (0,
                s.o8)(null == (u = p.params) ? void 0 : u.tag) && (null == (l = p.params) || delete l.tag),
        ...
        var Fr = Object.defineProperty
          ...
          , Xr = (t, e) => {
            for (var r in e || (e = {}))
                Jr.call(e, r) && Yr(t, r, e[r]);
            if (Gr)
                for (var r of Gr(e))
                    Qr.call(e, r) && Yr(t, r, e[r]);
            return t
        }
          , ti = (t, e) => Zr(t, Wr(e));
        class ei extends v {
            constructor(t, e) {
                ...
                this.isSubscribed = async t => !!this.topics.includes(t) || await new Promise(( (e, r) => {
                    ...
                    const n = setInterval(( () => {
                        !this.pending.has(t) && this.topics.includes(t) && (clearInterval(n),
                        i.stop(this.pendingSubscriptionWatchLabel),
                        e(!0)),
                        i.elapsed(this.pendingSubscriptionWatchLabel) >= Pr && (clearInterval(n),
                        i.stop(this.pendingSubscriptionWatchLabel),
            ...
            async unsubscribeById(t, e, r) {
                ...
                try {
                    ...
                    const n = (0,
                    s.D6)("USER_DISCONNECTED", `${this.name}, ${t}`);
            ...
            async batchSubscribe(t) {
                ...
                (0,
                s.qt)(e) && this.onBatchSubscribe(e.map(( (e, r) => ti(Xr({}, t[r]), {
                    id: e
                }))))
            }
            async onConnect() {
        ...
        class ai extends d {
            constructor(t) {
                ...
                this.messages = new Vr(this.logger,t.core),
                this.subscriber = new ei(this,this.logger),
                this.publisher = new Br(this,this.logger),
            ...
            async init() {
                ...
                try {
                    ...
                    this.logger.warn(`Connection via ${this.relayUrl} failed, attempting to connect via failover domain ${ar}...`),
            ...
            async subscribe(t, e) {
                ...
                if (n)
                    return n;
                const s = e => {
                    e.topic === t && (this.subscriber.off(_r, s),
                    i())
                }
                ;
                return await Promise.all([new Promise((t => {
                    i = t,
                    this.subscriber.on(_r, s)
                }
                )), new Promise((async r => {
            ...
            async shouldIgnoreMessageEvent(t) {
                ...
                if (!await this.subscriber.isSubscribed(e))
                    return this.logger.debug(`Ignoring message for non-subscribed topic ${e}`),
                    !0;
        ...
        var ci = Object.defineProperty
          ...
          , fi = (t, e) => {
            for (var r in e || (e = {}))
                ui.call(e, r) && pi(t, r, e[r]);
            if (hi)
                for (var r of hi(e))
                    li.call(e, r) && pi(t, r, e[r]);
            return t
        }
        ;
        class di extends g {
        ...
        class gi {
            constructor(t, e) {
                ...
                this.create = async () => {
                    ...
                    return await this.pairings.set(e, n),
                ...
                this.pair = async t => {
                    this.isInitialized(),
                    this.isValidPair(t);
                    const {topic: e, symKey: r, relay: i} = (0,
                    s.he)(t.uri);
                    let n;
                    if (this.pairings.keys.includes(e) && (n = this.pairings.get(e),
                    n.active))
                        throw new Error(`Pairing already exists: ${e}. Please try again with a new connection URI.`);
                ...
                this.sendRequest = async (t, e, r) => {
                    const i = it(e, r)
                      ...
                      , s = Sr[e].req;
                    return this.core.history.set(t, i),
                ...
                this.isValidPair = t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `pair() params: ${t}`);
                        throw new Error(e)
                    }
                    if (!(0,
                    s.jv)(t.uri)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `pair() uri: ${t.uri}`);
                        throw new Error(e)
                    }
                }
                ,
                this.isValidPing = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `ping() params: ${t}`);
                        throw new Error(e)
                    }
                    const {topic: e} = t;
                ...
                this.isValidDisconnect = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `disconnect() params: ${t}`);
                        throw new Error(e)
                    }
                    const {topic: e} = t;
                    await this.isValidPairingTopic(e)
                ...
                this.isValidPairingTopic = async t => {
                    ...
                    s.M_)(t, !1)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `pairing topic should be a string: ${t}`);
                        throw new Error(e)
                    }
                    if (!this.pairings.keys.includes(t)) {
                        const {message: e} = (0,
                        s.Z7)("NO_MATCHING_KEY", `pairing topic doesn't exist: ${t}`);
                        throw new Error(e)
                    }
                    if ((0,
                ...
                this.logger = (0,
                c.generateChildLogger)(e, this.name),
                this.pairings = new di(this.core,this.logger,this.name,this.storagePrefix)
            }
            get context() {
                return (0,
                c.getLoggerContext)(this.logger)
            ...
            registerRelayerEvents() {
                this.core.relayer.on(cr, (async t => {
                    ...
                    try {
                        gt(i) ? (this.core.history.set(e, i),
                        this.onRelayEventRequest({
                            topic: e,
                            payload: i
                        })) : vt(i) && (await this.core.history.resolve(i),
            ...
            cleanup() {
                try {
                    this.records.forEach((t => {
                        (0,
                        O.toMiliseconds)(t.expiry || 0) - Date.now() <= 0 && (this.logger.info(`Deleting expired history log: ${t.id}`),
        ...
        class yi extends y {
            ...
            formatTarget(t) {
                ...
                if ("number" == typeof t)
                    ...
                    s.Gq)(t);
                const {message: e} = (0,
                s.Z7)("UNKNOWN_TYPE", "Target type: " + typeof t);
                throw new Error(e)
            }
            ...
            constructor(t, e) {
                ...
                this.resolve = async t => {
                    ...
                    try {
                        ...
                        this.logger.info(`failed to resolve attestation: ${t.attestationId} from url: ${e}`),
                        this.logger.info(p),
                        r = await this.fetchAttestation(t.attestationId, $r)
                    }
                    return r
                }
                ,
        ...
        var wi = Object.defineProperty
          ...
          , Pi = (t, e) => {
            for (var r in e || (e = {}))
                bi.call(e, r) && Ii(t, r, e[r]);
            if (_i)
                for (var r of _i(e))
                    Ei.call(e, r) && Ii(t, r, e[r]);
            return t
        }
        ;
        class Si extends u {
            constructor(t) {
                ...
                this.relayUrl = (null === t || void 0 === t ? void 0 : t.relayUrl) || or,
                this.customStoragePrefix = null != t && t.customStoragePrefix ? `:${t.customStoragePrefix}` : "";
                ...
                this.crypto = new Hr(this,this.logger,null === t || void 0 === t ? void 0 : t.keychain),
                this.history = new vi(this,this.logger),
                this.expirer = new yi(this,this.logger),
                this.storage = null != t && t.storage ? t.storage : new o.ZP(Pi(Pi({}, rr), null === t || void 0 === t ? void 0 : t.storageOptions)),
                this.relayer = new ai({
                    core: this,
                    logger: this.logger,
                    relayUrl: this.relayUrl,
                ...
                this.pairing = new gi(this,this.logger),
                this.verify = new mi(this.projectId || "",this.logger)
            }
            static async init(t) {
                const e = new Si(t);
                await e.initialize();
        ...
        var ki = Object.defineProperty
          ...
          , Fi = (t, e) => {
            for (var r in e || (e = {}))
                Vi.call(e, r) && Ki(t, r, e[r]);
            if (Hi)
                for (var r of Hi(e))
                    Bi.call(e, r) && Ki(t, r, e[r]);
            return t
        }
          , Zi = (t, e) => $i(t, Ui(e));
        class Wi extends _ {
            constructor(t) {
                ...
                this.connect = async t => {
                    ...
                    const {pairingTopic: r, requiredNamespaces: i, optionalNamespaces: n, sessionProperties: o, relays: a} = e;
                    let c, h = r, u = !1;
                    if (h && (u = this.client.core.pairing.pairings.get(h).active),
                    !h || !u) {
                    ...
                    !h) {
                        const {message: t} = (0,
                        s.Z7)("NO_MATCHING_KEY", `connect() pairing topic: ${h}`);
                        throw new Error(t)
                    }
                ...
                this.approve = async t => {
                    ...
                    const {id: e, relayProtocol: r, namespaces: i, sessionProperties: n} = t
                      , o = this.client.proposal.get(e);
                    let {pairingTopic: a, proposer: c, requiredNamespaces: h, optionalNamespaces: u} = o;
                    a = a || "",
                    (0,
                    s.L5)(h) || (h = (0,
                    s.fc)(i, "approve()"));
                ...
                this.reject = async t => {
                    ...
                    const {id: e, reason: r} = t
                      , {pairingTopic: i} = this.client.proposal.get(e);
                    i && (await this.sendError(e, i, r),
                    await this.client.proposal.delete(e, (0,
                    s.D6)("USER_DISCONNECTED")))
                }
                ,
                ...
                this.request = async t => {
                    ...
                    const {chainId: e, request: r, topic: i, expiry: n} = t
                      , o = et()
                      , {done: a, resolve: c, reject: h} = (0,
                    s.H1)(n, "Request expired. Please try again.");
                    return this.events.once((0,
                ...
                this.respond = async t => {
                    ...
                    yt(r) ? await this.sendResult({
                        ...
                        result: r.result,
                        throwOnFailedPublish: !0
                    }) : mt(r) && await this.sendError(i, e, r.error),
                ...
                this.deleteSession = async (t, e) => {
                    ...
                    this.client.core.storage.removeItem(Ti).catch((t => this.client.logger.warn(t)))
                }
                ,
                ...
                this.deletePendingSessionRequest = async function(t, r) {
                    ...
                    await Promise.all([e.client.pendingRequest.delete(t, r), i ? Promise.resolve() : e.client.core.expirer.del(t)]),
                    e.sessionRequestQueue.queue = e.sessionRequestQueue.queue.filter((e => e.id !== t)),
                    i && (e.sessionRequestQueue.state = Di)
                }
                ,
                ...
                this.setPendingSessionRequest = async t => {
                    const e = Li.wc_sessionRequest.req.ttl
                      , {id: r, topic: i, params: n, verifyContext: o} = t;
                ...
                this.sendRequest = async t => {
                    const {topic: e, method: r, params: i, expiry: n, relayRpcId: o, clientRpcId: a, throwOnFailedPublish: c} = t
                      , h = it(r, i, a);
                    if ((0,
                    s.jU)() && zi.includes(r)) {
                        const t = (0,
                    ...
                    c ? (l.internal = Zi(Fi({}, l.internal), {
                        throwOnFailedPublish: !0
                    }),
                    await this.client.core.relayer.publish(e, u, l)) : this.client.core.relayer.publish(e, u, l).catch((t => this.client.logger.error(t))),
                    h.id
                }
                ,
                this.sendResult = async t => {
                    const {id: e, topic: r, result: i, throwOnFailedPublish: n} = t
                      , s = nt(e, i)
                      , o = await this.client.core.crypto.encode(r, s)
                      , a = await this.client.core.history.get(r, e)
                      , c = Li[a.request.method].res;
                ...
                this.sendError = async (t, e, r) => {
                    ...
                    this.client.core.relayer.publish(e, n, o),
                ...
                this.onRelayEventResponse = async t => {
                    const {topic: e, payload: r} = t
                      , i = (await this.client.core.history.get(e, r.id)).request.method;
                    switch (i) {
                    case "wc_sessionPropose":
                ...
                this.onRelayEventUnknownPayload = t => {
                    const {topic: e} = t
                      , {message: r} = (0,
                    s.Z7)("MISSING_OR_INVALID", `Decoded payload on topic ${e} is not identifiable as a JSON-RPC request or a response.`);
                    throw new Error(r)
                }
                ,
                ...
                this.onSessionSettleRequest = async (t, e) => {
                    ...
                    try {
                        ...
                        const {relay: r, controller: n, expiry: o, namespaces: a, requiredNamespaces: c, optionalNamespaces: h, sessionProperties: u, pairingTopic: l} = e.params
                          , p = Fi({
                            topic: t,
                            relay: r,
                            expiry: o,
                ...
                this.onSessionRequest = async (t, e) => {
                    ...
                    try {
                        ...
                        const e = (0,
                        s.rj)(JSON.stringify(it("wc_sessionRequest", i, r)))
                ...
                this.cleanupAfterResponse = t => {
                    ...
                    setTimeout(( () => {
                        this.sessionRequestQueue.state = Di,
                        this.processSessionRequestQueue()
                    }
                    ), (0,
                    O.toMiliseconds)(this.requestQueueDelay))
                ...
                this.isValidConnect = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `connect() params: ${JSON.stringify(t)}`);
                        throw new Error(e)
                    }
                    const {pairingTopic: e, requiredNamespaces: r, optionalNamespaces: i, sessionProperties: n, relays: o} = t;
                    if ((0,
                    ...
                    !(0,
                    s.o8)(i) && 0 !== (0,
                    s.L5)(i) && this.validateNamespaces(i, "optionalNamespaces"),
                    (0,
                ...
                this.isValidApprove = async t => {
                    ...
                    s.EJ)(t))
                        throw new Error((0,
                        s.Z7)("MISSING_OR_INVALID", `approve() params: ${t}`).message);
                    const {id: e, namespaces: r, relayProtocol: i, sessionProperties: n} = t;
                    ...
                    s.M_)(i, !0)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `approve() relayProtocol: ${i}`);
                        throw new Error(t)
                    }
                    (0,
                    s.o8)(n) || this.validateSessionProps(n, "sessionProperties")
                ...
                this.isValidReject = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `reject() params: ${t}`);
                        throw new Error(e)
                    }
                    const {id: e, reason: r} = t;
                    ...
                    s.$t)(r)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(r)}`);
                        throw new Error(t)
                    }
                }
                ,
                this.isValidSessionSettleRequest = t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${t}`);
                        throw new Error(e)
                    }
                ...
                this.isValidUpdate = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `update() params: ${t}`);
                        throw new Error(e)
                    }
                    const {topic: e, namespaces: r} = t;
                    ...
                    const o = (0,
                    s.rF)(i.requiredNamespaces, r, "update()");
                    if (o)
                        throw new Error(o.message)
                }
                ,
                this.isValidExtend = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `extend() params: ${t}`);
                        throw new Error(e)
                    }
                    const {topic: e} = t;
                    await this.isValidSessionTopic(e)
                ...
                this.isValidRequest = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `request() params: ${t}`);
                        throw new Error(e)
                    }
                    ...
                    s.p8)(o, i)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `request() chainId: ${i}`);
                        throw new Error(t)
                    }
                    if (!(0,
                    s.hH)(r)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `request() ${JSON.stringify(r)}`);
                        throw new Error(t)
                    }
                    if (!(0,
                    s.al)(o, i, r.method)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `request() method: ${r.method}`);
                        throw new Error(t)
                    }
                    if (n && !(0,
                    s.ON)(n, qi)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `request() expiry: ${n}. Expiry must be a number (in seconds) between ${qi.min} and ${qi.max}`);
                        throw new Error(t)
                    }
                }
                ,
                this.isValidRespond = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `respond() params: ${t}`);
                        throw new Error(e)
                    }
                    const {topic: e, response: r} = t;
                    ...
                    s.JT)(r)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `respond() response: ${JSON.stringify(r)}`);
                        throw new Error(t)
                    }
                }
                ,
                ...
                this.isValidEmit = async t => {
                    ...
                    s.EJ)(t)) {
                        const {message: e} = (0,
                        s.Z7)("MISSING_OR_INVALID", `emit() params: ${t}`);
                        throw new Error(e)
                    }
                    const {topic: e, event: r, chainId: i} = t;
                    await this.isValidSessionTopic(e);
                    ...
                    s.p8)(n, i)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `emit() chainId: ${i}`);
                        throw new Error(t)
                    }
                    if (!(0,
                    s.nf)(r)) {
                        const {message: t} = (0,
                        s.Z7)("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(r)}`);
                        throw new Error(t)
                    }
                    if (!(0,
                    s.sI)(n, i, r.name)) {
                ...
                this.getVerifyContext = async (t, e) => {
                    ...
                    try {
                        ...
                        r.verified.validation = i.origin === new URL(e.url).origin ? "VALID" : "INVALID")
                    } catch (i) {
                ...
                this.validateSessionProps = (t, e) => {
                    Object.values(t).forEach((t => {
                        ...
                        s.M_)(t, !1)) {
                            const {message: r} = (0,
                            s.Z7)("MISSING_OR_INVALID", `${e} must be in Record<string, string> format. Received: ${JSON.stringify(t)}`);
                            throw new Error(r)
                        }
                    }
                    ))
            ...
            registerRelayerEvents() {
                this.client.core.relayer.on(cr, (async t => {
                    ...
                    try {
                        gt(i) ? (this.client.core.history.set(e, i),
                        this.onRelayEventRequest({
                            topic: e,
                            payload: i
                        })) : vt(i) ? (await this.client.core.history.resolve(i),
                        await this.onRelayEventResponse({
                            topic: e,
                            payload: i
                        }),
            ...
            async isValidSessionTopic(t) {
                ...
                s.M_)(t, !1)) {
                    const {message: e} = (0,
                    s.Z7)("MISSING_OR_INVALID", `session topic should be a string: ${t}`);
                    throw new Error(e)
                }
                if (!this.client.session.keys.includes(t)) {
                    const {message: e} = (0,
                    s.Z7)("NO_MATCHING_KEY", `session topic doesn't exist: ${t}`);
                    throw new Error(e)
                }
                if ((0,
            ...
            async isValidSessionOrPairingTopic(t) {
                if (this.client.session.keys.includes(t))
                    ...
                    if (!this.client.core.pairing.pairings.keys.includes(t)) {
                        ...
                        s.M_)(t, !1)) {
                            const {message: e} = (0,
                            s.Z7)("NO_MATCHING_KEY", `session or pairing topic doesn't exist: ${t}`);
                            throw new Error(e)
                        }
                        {
                            const {message: e} = (0,
                            s.Z7)("MISSING_OR_INVALID", `session or pairing topic should be a string: ${t}`);
                            throw new Error(e)
                        }
                    }
            ...
            async isValidProposalId(t) {
                ...
                s.Q0)(t)) {
                    const {message: e} = (0,
                    s.Z7)("MISSING_OR_INVALID", `proposal id should be a number: ${t}`);
                    throw new Error(e)
                }
                if (!this.client.proposal.keys.includes(t)) {
                    const {message: e} = (0,
                    s.Z7)("NO_MATCHING_KEY", `proposal id doesn't exist: ${t}`);
                    throw new Error(e)
                }
                if ((0,
        ...
        class Yi extends w {
            constructor(t) {
                ...
                ,
                this.name = (null === t || void 0 === t ? void 0 : t.name) || Ri,
                ...
                this.core = (null === t || void 0 === t ? void 0 : t.core) || new Oi(t),
                this.logger = (0,
                c.generateChildLogger)(e, this.name),
                this.session = new Ji(this.core,this.logger),
                this.proposal = new Gi(this.core,this.logger),
                this.pendingRequest = new Qi(this.core,this.logger),
                this.engine = new Wi(this)
            }
            static async init(t) {
                const e = new Yi(t);
        ...
        !function(t, e) {
            (function() {
                var r, i = "Expected a function", n = "__lodash_hash_undefined__", s = "__lodash_placeholder__", o = 16, a = 32, c = 64, h = 128, u = 256, l = 1 / 0, p = 9007199254740991, f = NaN, d = 4294967295, g = [["ary", h], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", o], ["flip", 512], ["partial", a], ["partialRight", c], ["rearg", u]], v = "[object Arguments]", y = "[object Array]", m = "[object Boolean]", w = "[object Date]", _ = "[object Error]", b = "[object Function]", E = "[object GeneratorFunction]", I = "[object Map]", P = "[object Number]", S = "[object Object]", O = "[object Promise]", x = "[object RegExp]", C = "[object Set]", R = "[object String]", A = "[object Symbol]", T = "[object WeakMap]", N = "[object ArrayBuffer]", j = "[object DataView]", L = "[object Float32Array]", q = "[object Float64Array]", D = "[object Int8Array]", M = "[object Int16Array]", z = "[object Int32Array]", k = "[object Uint8Array]", $ = "[object Uint8ClampedArray]", U = "[object Uint16Array]", H = "[object Uint32Array]", V = /\b__p \+= '';/g, B = /\b(__p \+=) '' \+/g, K = /(__e\(.*?\)|\b__t\)) \+\n'';/g, F = /&(?:amp|lt|gt|quot|#39);/g, Z = /[&<>"']/g, W = RegExp(F.source), G = RegExp(Z.source), J = /<%-([\s\S]+?)%>/g, Q = /<%([\s\S]+?)%>/g, Y = /<%=([\s\S]+?)%>/g, X = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, tt = /^\w*$/, et = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, rt = /[\\^$.*+?()[\]{}|]/g, it = RegExp(rt.source), nt = /^\s+/, st = /\s/, ot = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, at = /\{\n\/\* \[wrapped with (.+)\] \*/, ct = /,? & /, ht = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, ut = /[()=,{}\[\]\/\s]/, lt = /\\(\\)?/g, pt = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, ft = /\w*$/, dt = /^[-+]0x[0-9a-f]+$/i, gt = /^0b[01]+$/i, vt = /^\[object .+?Constructor\]$/, yt = /^0o[0-7]+$/i, mt = /^(?:0|[1-9]\d*)$/, wt = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, _t = /($^)/, bt = /['\n\r\u2028\u2029\\]/g, Et = "\\ud800-\\udfff", It = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Pt = "\\u2700-\\u27bf", St = "a-z\\xdf-\\xf6\\xf8-\\xff", Ot = "A-Z\\xc0-\\xd6\\xd8-\\xde", xt = "\\ufe0e\\ufe0f", Ct = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", Rt = "['\u2019]", At = "[" + Et + "]", Tt = "[" + Ct + "]", Nt = "[" + It + "]", jt = "\\d+", Lt = "[" + Pt + "]", qt = "[" + St + "]", Dt = "[^" + Et + Ct + jt + Pt + St + Ot + "]", Mt = "\\ud83c[\\udffb-\\udfff]", zt = "[^" + Et + "]", kt = "(?:\\ud83c[\\udde6-\\uddff]){2}", $t = "[\\ud800-\\udbff][\\udc00-\\udfff]", Ut = "[" + Ot + "]", Ht = "\\u200d", Vt = "(?:" + qt + "|" + Dt + ")", Bt = "(?:" + Ut + "|" + Dt + ")", Kt = "(?:['\u2019](?:d|ll|m|re|s|t|ve))?", Ft = "(?:['\u2019](?:D|LL|M|RE|S|T|VE))?", Zt = "(?:" + Nt + "|" + Mt + ")" + "?", Wt = "[" + xt + "]?", Gt = Wt + Zt + ("(?:" + Ht + "(?:" + [zt, kt, $t].join("|") + ")" + Wt + Zt + ")*"), Jt = "(?:" + [Lt, kt, $t].join("|") + ")" + Gt, Qt = "(?:" + [zt + Nt + "?", Nt, kt, $t, At].join("|") + ")", Yt = RegExp(Rt, "g"), Xt = RegExp(Nt, "g"), te = RegExp(Mt + "(?=" + Mt + ")|" + Qt + Gt, "g"), ee = RegExp([Ut + "?" + qt + "+" + Kt + "(?=" + [Tt, Ut, "$"].join("|") + ")", Bt + "+" + Ft + "(?=" + [Tt, Ut + Vt, "$"].join("|") + ")", Ut + "?" + Vt + "+" + Kt, Ut + "+" + Ft, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", jt, Jt].join("|"), "g"), re = RegExp("[" + Ht + Et + It + xt + "]"), ie = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, ne = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], se = -1, oe = {};
                oe[L] = oe[q] = oe[D] = oe[M] = oe[z] = oe[k] = oe[$] = oe[U] = oe[H] = !0,
                oe[v] = oe[y] = oe[N] = oe[m] = oe[j] = oe[w] = oe[_] = oe[b] = oe[I] = oe[P] = oe[S] = oe[x] = oe[C] = oe[R] = oe[T] = !1;
                var ae = {};
                ae[v] = ae[y] = ae[N] = ae[j] = ae[m] = ae[w] = ae[L] = ae[q] = ae[D] = ae[M] = ae[z] = ae[I] = ae[P] = ae[S] = ae[x] = ae[C] = ae[R] = ae[A] = ae[k] = ae[$] = ae[U] = ae[H] = !0,
                ae[_] = ae[b] = ae[T] = !1;
                var ce = {
                    "\\": "\\",
                    "'": "'",
                ...
                var dr = function t(e) {
                    ...
                    function Wr(t, e) {
                        var r = Vo(t)
                          ...
                          , c = a.length;
                        for (var h in t)
                            (e || qt.call(t, h)) && (!o || !("length" == h || n && ("offset" == h || "parent" == h) || s && ("buffer" == h || "byteLength" == h || "byteOffset" == h) || ys(h, c))) && a.push(h);
                        return a
                    }
                    function Gr(t) {
                        var e = t.length;
                    ...
                    function ni(t, e) {
                        for (var i = -1, n = e.length, s = st(n), o = null == t; ++i < n; )
                            s[i] = o ? r : Sa(t, e[i]);
                        return s
                    }
                    function si(t, e, i) {
                        return t === t && (i !== r && (t = t <= i ? t : i),
                        e !== r && (t = t >= e ? t : e)),
                        t
                    }
                    function oi(t, e, i, n, s, o) {
                        var a, c = 1 & e, h = 2 & e, u = 4 & e;
                        if (i && (a = s ? i(t, n, s, o) : i(t)),
                        a !== r)
                            return a;
                        if (!Xo(t))
                            return t;
                    ...
                    Ur.prototype = kr($r.prototype),
                    Ur.prototype.constructor = Ur,
                    Hr.prototype = kr($r.prototype),
                    ...
                    Br.prototype.delete = function(t) {
                        var e = this.__data__
                          , r = ti(e, t);
                        return !(r < 0) && (r == e.length - 1 ? e.pop() : Gt.call(e, r, 1),
                        --this.size,
                        !0)
                    }
                    ,
                    ...
                    function bi(t, e) {
                        for (var i = 0, n = (e = mn(e, t)).length; null != t && i < n; )
                            t = t[qs(e[i++])];
                        return i && i == n ? t : r
                    }
                    function Ei(t, e, r) {
                    ...
                    function xi(t, e, i) {
                        for (var n = i ? Ne : Te, s = t[0].length, o = t.length, a = o, c = st(o), h = 1 / 0, u = []; a--; ) {
                            ...
                            a && e && (l = je(l, Qe(e))),
                            h = yr(l.length, h),
                            c[a] = !i && (e || s >= 120 && l.length >= 120) ? new Fr(a && l) : r
                        }
                        l = t[0];
                        var p = -1
                          , f = c[0];
                    ...
                    function Ai(t, e, i, n, s) {
                        return t === e || (null == t || null == e || !ta(t) && !ta(e) ? t !== t && e !== e : function(t, e, i, n, s, o) {
                            ...
                            if (f && !l)
                                return o || (o = new Zr),
                                a || ca(t) ? ts(t, e, i, n, s, o) : function(t, e, r, i, n, s, o) {
                                    switch (r) {
                                    case j:
                            ...
                            function(t, e, i, n, s, o) {
                                ...
                                for (var y = a; ++p < h; ) {
                                    var m = t[f = c[p]]
                                      , w = e[f];
                                    if (n)
                                        var _ = a ? n(w, m, f, e, t, o) : n(m, w, f, t, e, o);
                    ...
                    function qi(t) {
                        ...
                        var e = Es(t)
                          , r = [];
                        for (var i in t)
                            "constructor" == i && (e || !qt.call(t, i)) || r.push(i);
                        return r
                    }
                    function Di(t, e) {
                        return t < e
                                ...
                                !function(t, e, i, n, s, o, a) {
                                    ...
                                    if (p) {
                                        var f = Vo(h)
                                          ...
                                          , g = !f && !d && ca(h);
                                        l = h,
                                        f || d || g ? Vo(c) ? l = c : Fo(c) ? l = Cn(c) : d ? (p = !1,
                                        l = En(h, !0)) : g ? (p = !1,
                                        l = Pn(h, !0)) : l = [] : ia(h) || Ho(h) ? (l = c,
                                        Ho(c) ? l = va(c) : (!Xo(c) || Jo(c)) && (l = gs(h))) : p = !1
                                    }
                                    p && (a.set(h, l),
                                    s(l, h, n, o, a),
                                    a.delete(h)),
                    ...
                    function Bi(t, e, r, i) {
                        ...
                        for (t === e && (e = Cn(e)),
                        r && (a = je(t, Qe(r))); ++s < o; )
                            for (var c = 0, h = e[s], u = r ? r(h) : h; (c = n(a, u, c, i)) > -1; )
                                a !== t && Gt.call(a, c, 1),
                                Gt.call(t, c, 1);
                        return t
                    }
                    ...
                    function sn(t, e, i, n) {
                        ...
                        for (var a = (e = i(e)) !== e, c = null === e, h = aa(e), u = e === r; s < o; ) {
                            ...
                            if (a)
                                ...
                                y = u ? g && (n || f) : c ? g && f && (n || !d) : h ? g && f && !d && (n || !v) : !d && !v && (n ? p <= e : p < e);
                            y ? s = l + 1 : o = l
                        }
                    ...
                    function pn(t, e, r, i) {
                        for (var n = t.length, s = i ? n : -1; (i ? s-- : ++s < n) && e(t[s], s, t); )
                            ;
                    ...
                    function dn(t, e, r) {
                        ...
                        for (var n = -1, s = st(i); ++n < i; )
                            for (var o = t[n], a = -1; ++a < i; )
                                a != n && (s[n] = hi(s[n] || o, t[a], e, r));
                    ...
                    function Sn(t, e) {
                        if (t !== e) {
                            var i = t !== r
                              ...
                              , h = e === e
                              , u = aa(e);
                            if (!c && !u && !o && t > e || o && a && h && !c && !u || n && a && h || !i && h || !s)
                                return 1;
                            if (!n && !o && !u && t < e || u && i && s && !n && !o || c && i && s || !a && s || !h)
                                return -1
                        }
                        return 0
                    }
                    function On(t, e, r, i) {
                        for (var n = -1, s = t.length, o = r.length, a = -1, c = e.length, h = vr(s - o, 0), u = st(c + h), l = !i; ++a < c; )
                            u[a] = e[a];
                        for (; ++n < o; )
                            (l || n < s) && (u[r[n]] = t[n]);
                        for (; h--; )
                    ...
                    function xn(t, e, r, i) {
                        for (var n = -1, s = t.length, o = -1, a = r.length, c = -1, h = e.length, u = vr(s - a, 0), l = st(u + h), p = !i; ++n < u; )
                            l[n] = t[n];
                        for (var f = n; ++c < h; )
                            l[f + c] = e[c];
                        for (; ++o < a; )
                    ...
                    function Nn(t, e) {
                        return function(r, i) {
                            ...
                            if (!Ko(r))
                                return t(r, i);
                            for (var n = r.length, s = e ? n : -1, o = Ot(r); (e ? s-- : ++s < n) && !1 !== i(o[s], s, o); )
                                ;
                            return r
                        }
                    }
                    ...
                    function kn(t, e, i, n, s, o, a, c, u, l) {
                        ...
                        return function h() {
                            ...
                            p && u < m && (w.length = u),
                            this && this !== fe && this instanceof h && (S = y || Dn(S)),
                            S.apply(P, w)
                        }
                    }
                    function $n(t, e) {
                    ...
                    function Un(t, e) {
                        return function(i, n) {
                            ...
                            n !== r) {
                                if (s === r)
                                    return n;
                                "string" == typeof i || "string" == typeof n ? (i = cn(i),
                                n = cn(n)) : (i = an(i),
                                n = an(n)),
                                s = t(i, n)
                            }
                    ...
                    function Bn(t) {
                        return function(e, i, n) {
                            return n && "number" != typeof n && ms(e, i, n) && (i = n = r),
                            e = pa(e),
                            i === r ? (i = e,
                            e = 0) : i = pa(i),
                            function(t, e, r, i) {
                                for (var n = -1, s = vr(de((e - t) / (r || 1)), 0), o = st(s); s--; )
                                    o[i ? s : ++n] = t,
                                    t += r;
                                return o
                    ...
                    function Jn(t, e, n, l, p, f, d, g) {
                        ...
                        if (_ && function(t, e) {
                            ...
                            c = e[7],
                            c && (t[7] = c),
                            i & h && (t[8] = null == t[8] ? e[8] : yr(t[8], e[8])),
                            null == t[9] && (t[9] = e[9]),
                            t[0] = e[0],
                            t[1] = n
                        }(b, _),
                        ...
                        e && 1 != e)
                            E = 8 == e || e == o ? function(t, e, i) {
                                var n = Dn(t);
                                return function s() {
                                    for (var o = arguments.length, a = st(o), c = o, h = os(s); c--; )
                                        a[c] = arguments[c];
                                ...
                                var n = 1 & e
                                  , s = Dn(t);
                                return function e() {
                                    for (var o = -1, a = arguments.length, c = -1, h = i.length, u = st(h + a), l = this && this !== fe && this instanceof e ? s : t; ++c < h; )
                                        u[c] = i[c];
                                    for (; a--; )
                                        u[c++] = arguments[++o];
                    ...
                    function ts(t, e, i, n, s, o) {
                        ...
                        o.set(e, t); ++p < c; ) {
                            var g = t[p]
                              , v = e[p];
                            if (n)
                                var y = a ? n(v, g, p, e, t, o) : n(g, v, p, t, e, o);
                            if (y !== r) {
                                if (y)
                                    continue;
                                f = !1;
                    ...
                    function _s(t) {
                        var e = ss(t)
                          , r = zr[e];
                        if ("function" != typeof r || !(e in Hr.prototype))
                            return !1;
                        if (t === r)
                            return !0;
                        var i = ns(r);
                    ...
                    function Ss(t, e, i) {
                        ...
                        function() {
                            for (var r = arguments, n = -1, s = vr(r.length - e, 0), o = st(s); ++n < s; )
                                o[n] = r[e + n];
                            n = -1;
                            for (var a = st(e + 1); ++n < e; )
                                a[n] = r[n];
                            return a[e] = i(o),
                            Se(t, this, a)
                        }
                    ...
                    function Ms(t) {
                        ...
                        return e.__actions__ = Cn(t.__actions__),
                    ...
                    var zs = Wi((function(t, e) {
                      ...
                      , ks = Wi((function(t, e) {
                        var i = Ws(e);
                        return Fo(i) && (i = r),
                        Fo(t) ? hi(t, gi(e, 1, Fo, !0), as(i, 2)) : []
                    }
                    ))
                      , $s = Wi((function(t, e) {
                        var i = Ws(e);
                        return Fo(i) && (i = r),
                        Fo(t) ? hi(t, gi(e, 1, Fo, !0), r, i) : []
                    }
                    ));
                    function Us(t, e, r) {
                    ...
                    var Ks = Wi((function(t) {
                      ...
                      , Fs = Wi((function(t) {
                        var e = Ws(t)
                          , i = je(t, vn);
                        return e === Ws(i) ? e = r : i.pop(),
                        i.length && i[0] === t[0] ? xi(i, as(e, 2)) : []
                    }
                    ))
                      , Zs = Wi((function(t) {
                        var e = Ws(t)
                          , i = je(t, vn);
                        return (e = "function" == typeof e ? e : r) && i.pop(),
                        i.length && i[0] === t[0] ? xi(i, r, e) : []
                    }
                    ));
                    function Ws(t) {
                    ...
                    function Ao(t, e, n) {
                        var s, o, a, c, h, u, l = 0, p = !1, f = !1, d = !0;
                        if ("function" != typeof t)
                            throw new Rt(i);
                        function g(e) {
                            var i = s
                        ...
                        return e = ga(e) || 0,
                        Xo(n) && (p = !!n.leading,
                        a = (f = "maxWait"in n) ? vr(ga(n.maxWait) || 0, e) : a,
                    ...
                    function jo(t, e) {
                        ...
                        return r.cache = new (jo.Cache || Kr),
                        r
                    }
                    function Lo(t) {
                        if ("function" != typeof t)
                    ...
                    var qo = wn((function(t, e) {
                        ...
                        return Wi((function(i) {
                            for (var n = -1, s = yr(i.length, r); ++n < s; )
                    ...
                    function oc(t, e, r) {
                        var i = Aa(e)
                          , n = _i(e, i);
                        null == r && (!Xo(e) || !n.length && i.length) && (r = e,
                        e = t,
                        t = this,
                        n = _i(e, Aa(e)));
                    ...
                    ,
                    zr.chain = uo,
                    zr.chunk = function(t, e, i) {
                        e = (i ? ms(t, e, i) : e === r) ? 1 : vr(fa(e), 0);
                        var n = null == t ? 0 : t.length;
                        if (!n || e < 1)
                            return [];
                        for (var s = 0, o = 0, a = st(de(n / e)); s < n; )
                            a[o++] = en(t, s, s += e);
                        return a
                    }
                    ,
                    ...
                    zr.concat = function() {
                        ...
                        if (!t)
                            return [];
                        for (var e = st(t - 1), r = arguments[0], i = t; i--; )
                            e[i - 1] = arguments[i];
                    ...
                    zr.fill = function(t, e, i, n) {
                        ...
                        return s ? (i && "number" != typeof i && ms(t, e, i) && (i = 0,
                        n = s),
                        function(t, e, i, n) {
                            var s = t.length;
                            for ((i = fa(i)) < 0 && (i = -i > s ? 0 : s + i),
                            (n = n === r || n > s ? s : fa(n)) < 0 && (n += s),
                            n = i > n ? 0 : da(n); i < n; )
                                t[i++] = e;
                            return t
                        }(t, e, i, n)) : []
                    ...
                    zr.orderBy = function(t, e, i, n) {
                        return null == t ? [] : (Vo(e) || (e = null == e ? [] : [e]),
                        Vo(i = n ? r : i) || (i = null == i ? [] : [i]),
                        Hi(t, e, i))
                    }
                    ,
                    zr.over = cc,
                    ...
                    ,
                    zr.reverse = Ys,
                    zr.sampleSize = function(t, e, i) {
                        return e = (i ? ms(t, e, i) : e === r) ? 1 : fa(e),
                        (Vo(t) ? Jr : Ji)(t, e)
                    }
                    ,
                    ...
                    zr.slice = function(t, e, i) {
                        var n = null == t ? 0 : t.length;
                        return n ? (i && "number" != typeof i && ms(t, e, i) ? (e = 0,
                        i = n) : (e = null == e ? 0 : fa(e),
                        i = i === r ? n : fa(i)),
                        en(t, e, i)) : []
                    }
                    ...
                    zr.split = function(t, e, i) {
                        return i && "number" != typeof i && ms(t, e, i) && (e = i = r),
                        (i = i === r ? d : i >>> 0) ? (t = ya(t)) && ("string" == typeof e || null != e && !na(e)) && (!(e = cn(e)) && sr(t)) ? _n(lr(t), 0, i) : t.split(e, i) : []
                    }
                    ,
                    ...
                    zr.throttle = function(t, e, r) {
                        ...
                        if ("function" != typeof t)
                            throw new Rt(i);
                        return Xo(r) && (n = "leading"in r ? !!r.leading : n,
                    ...
                    zr.includes = function(t, e, r, i) {
                        ...
                        r = r && !i ? fa(r) : 0;
                        var n = t.length;
                        return r < 0 && (r = vr(n + r, 0)),
                        oa(t) ? r <= n && t.indexOf(e, r) > -1 : !!n && Ue(t, e, r) > -1
                    }
                    ,
                    ...
                    zr.isEmpty = function(t) {
                        if (null == t)
                            return !0;
                        if (Ko(t) && (Vo(t) || "string" == typeof t || "function" == typeof t.splice || Zo(t) || ca(t) || Ho(t)))
                            return !t.length;
                        var e = fs(t);
                        if (e == I || e == C)
                            return !t.size;
                    ...
                    zr.kebabCase = Va,
                    zr.last = Ws,
                    zr.lastIndexOf = function(t, e, i) {
                        var n = null == t ? 0 : t.length;
                        if (!n)
                            return -1;
                        var s = n;
                        return i !== r && (s = (s = fa(i)) < 0 ? vr(n + s, 0) : yr(s, n - 1)),
                        e === e ? function(t, e, r) {
                            for (var i = r + 1; i--; )
                                if (t[i] === e)
                                    return i;
                    ...
                    zr.parseInt = function(t, e, r) {
                        ...
                        wr(ya(t).replace(nt, ""), e || 0)
                    }
                    ,
                    zr.random = function(t, e, i) {
                        if (i && "boolean" != typeof i && ms(t, e, i) && (e = i = r),
                        i === r && ("boolean" == typeof e ? (i = e,
                        e = r) : "boolean" == typeof t && (i = t,
                        t = r)),
                        t === r && e === r ? (t = 0,
                        e = 1) : (t = pa(t),
                        e === r ? (e = t,
                    ...
                    zr.size = function(t) {
                        if (null == t)
                            return 0;
                        if (Ko(t))
                            return oa(t) ? ur(t) : t.length;
                        var e = fs(t);
                        return e == I || e == C ? t.size : Li(t).length
                    }
                    ,
                    zr.snakeCase = Fa,
                    zr.some = function(t, e, i) {
                        var n = Vo(t) ? Me : rn;
                        return i && ms(t, e, i) && (e = r),
                        n(t, as(e, 3))
                    }
                    ...
                    zr.template = function(t, e, i) {
                        ...
                        t = ya(t),
                        e = _a({}, e, n, Qn);
                        var s, o, a = _a({}, e.imports, n.imports, Qn), c = Aa(a), h = Ye(a, c), u = 0, l = e.interpolate || _t, p = "__p += '", f = xt((e.escape || _t).source + "|" + l.source + "|" + (l === Y ? pt : _t).source + "|" + (e.evaluate || _t).source + "|$", "g"), d = "//# sourceURL=" + (qt.call(e, "sourceURL") ? (e.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++se + "]") + "\n";
                        t.replace(f, (function(e, r, i, n, a, c) {
                            return i || (i = n),
                            p += t.slice(u, c).replace(bt, nr),
                            r && (s = !0,
                            p += "' +\n__e(" + r + ") +\n'"),
                            a && (o = !0,
                            p += "';\n" + a + ";\n__p += '"),
                        ...
                        if (g) {
                            ...
                            p = "with (obj) {\n" + p + "\n}\n";
                        p = (o ? p.replace(V, "") : p).replace(B, "$1").replace(K, "$1;"),
                    ...
                    zr.truncate = function(t, e) {
                        ...
                        if (Xo(e)) {
                            ...
                            i = "length"in e ? fa(e.length) : i,
                            n = "omission"in e ? cn(e.omission) : n
                        }
                        var o = (t = ya(t)).length;
                        if (sr(t)) {
                            var a = lr(t);
                    ...
                    Hr.prototype.slice = function(t, e) {
                        t = fa(t);
                        var i = this;
                        return i.__filtered__ && (t > 0 || e < 0) ? new Hr(i) : (t < 0 ? i = i.takeRight(-t) : t && (i = i.drop(t)),
                        e !== r && (i = (e = fa(e)) < 0 ? i.dropRight(-e) : i.take(e - t)),
                        i)
                    }
                    ,
                    ...
                    Hr.prototype.clone = function() {
                        ...
                        return t.__actions__ = Cn(this.__actions__),
                    ...
                    zr.prototype.reverse = function() {
                        ...
                        if (t instanceof Hr) {
                            var e = t;
                            return this.__actions__.length && (e = new Hr(this)),
        ...
        var un = Object.defineProperty
          ...
          , yn = (t, e) => {
            for (var r in e || (e = {}))
                dn.call(e, r) && vn(t, r, e[r]);
            if (fn)
                for (var r of fn(e))
                    gn.call(e, r) && vn(t, r, e[r]);
            return t
        }
          , mn = (t, e) => ln(t, pn(e));
        function wn(t, e, r) {
        ...
        function En(t) {
            ...
            for (const [a,c] of Object.entries(t)) {
                ...
                o[p] = mn(yn(yn({}, o[p]), c), {
                    ...
                    methods: (0,
                    s.eG)(h, null == (r = o[p]) ? void 0 : r.methods),
                    events: (0,
        ...
        function Pn(t) {
            ...
            for (const [r,i] of Object.entries(t)) {
                const t = i.methods || []
                  ...
                  , o = i.accounts || []
                  , a = (0,
                s.gp)(r) ? [r] : i.chains ? i.chains : bn(i.accounts);
                e[r] = {
                    chains: a,
                    methods: t,
                    events: n,
        ...
        class Rn {
            constructor(t) {
                ...
                this.events = xn("events"),
                this.client = xn("client"),
            ...
            setDefaultChain(t, e) {
                ...
                this.chainId = t,
                this.events.emit(an, `${this.name}:${t}`)
            }
            getAccounts() {
        ...
        var Mn = Object.defineProperty
          ...
          , Bn = (t, e) => {
            for (var r in e || (e = {}))
                Un.call(e, r) && Vn(t, r, e[r]);
            if ($n)
                for (var r of $n(e))
                    Hn.call(e, r) && Vn(t, r, e[r]);
            return t
        }
          , Kn = (t, e) => zn(t, kn(e));
        class Fn {
            ...
            async pair(t) {
                ...
                do {
                    ...
                    await i().then((t => {
                        this.session = t,
                        this.namespaces || (this.namespaces = Pn(t.namespaces),
            ...
            createProviders() {
                ...
                s.M)(t))))];
                Cn("client", this.client),
                Cn("events", this.events),
                Cn("disableProviderPing", this.disableProviderPing),
                t.forEach((t => {
                    if (!this.session)
                        return;
            ...
            registerEventListeners() {
                ...
                this.client.on("session_event", (t => {
                    ...
                    if ("accountsChanged" === r.name) {
                        const t = r.data;
                        t && (0,
                        s.qt)(t) && this.events.emit("accountsChanged", t.map(In))
                ...
                this.client.on("session_delete", (async t => {
                    ...
                    this.events.emit("disconnect", Kn(Bn({}, (0,
                    s.D6)("USER_DISCONNECTED")), {
                        data: t.topic
                    }))
                }
            ...
            setNamespaces(t) {
                const {namespaces: e, optionalNamespaces: r, sessionProperties: i} = t;
            ...
            onChainChanged(t) {
                ...
                e || this.getProvider(i).setDefaultChain(n),
        ...
        var Yn = Object.defineProperty
          ...
          , ss = (t, e) => {
            for (var r in e || (e = {}))
                rs.call(e, r) && ns(t, r, e[r]);
            if (es)
                for (var r of es(e))
                    is.call(e, r) && ns(t, r, e[r]);
            return t
        }
          , os = (t, e) => Xn(t, ts(e));
        function as(t) {
        ...
        class hs {
            ...
            async connect(t) {
                ...
                const {required: e, optional: r} = function(t) {
                    const {chains: e, optionalChains: r, methods: i, optionalMethods: n, events: o, optionalEvents: a, rpcMap: c} = t;
                    if (!(0,
                    s.qt)(e))
                    ...
                    if (!r && !a && !n && (null == u || !u.length) && (null == l || !l.length))
                        return {
                ...
                try {
                    ...
                    throw this.signer.logger.error(u),
                    u
                } finally {
            ...
            async initialize(t) {
                ...
                this.rpc.showQrModal) {
                    let t;
                    try {
                        const {WalletConnectModal: e} = await r.e(495).then(r.bind(r, 22495));
                        t = e
                    } catch {
            ...
            loadConnectOpts(t) {
                if (!t)
                    return;
                const {chains: e, optionalChains: r, rpcMap: i} = t;
                e && (0,
    ...
    86014: (t, e, r) => {
        ...
        const i = r(79486);
        e.HEARTBEAT_INTERVAL = i.FIVE_SECONDS,
        e.HEARTBEAT_EVENTS = {
    ...
    16114: (t, e, r) => {
        ...
        const i = r(73104);
        i.__exportStar(r(28576), e),
        i.__exportStar(r(17414), e),
        i.__exportStar(r(46427), e)
    }
    ,
    13023: (t, e, r) => {
        "use strict";
    ...
    18468: (t, e, r) => {
        ...
        const i = r(73104);
        i.__exportStar(r(88500), e),
        i.__exportStar(r(33041), e)
    }
    ,
    88500: (t, e) => {
        "use strict";
    ...
    79485: (t, e, r) => {
        ...
        i.__exportStar(r(27407), e),
        i.__exportStar(r(62199), e)
    }
    ,
    62199: (t, e, r) => {
        "use strict";
        ...
        function s(t, e) {
            return t[arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : i.PINO_CUSTOM_CONTEXT_KEY] = e,
            t
        }
        function o(t) {
            let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : i.PINO_CUSTOM_CONTEXT_KEY
              , r = "";
            return r = "undefined" === typeof t.bindings ? n(t, e) : t.bindings().context || "",
            r
        }
        function a(t, e) {
            ...
            !function(e) {
                ...
                function y() {
                    ...
                    this._initBody = function(t) {
                        var e;
                        this._bodyInit = t,
                        t ? "string" === typeof t ? this._bodyText = t : n && Blob.prototype.isPrototypeOf(t) ? this._bodyBlob = t : s && FormData.prototype.isPrototypeOf(t) ? this._bodyFormData = t : r && URLSearchParams.prototype.isPrototypeOf(t) ? this._bodyText = t.toString() : o && n && ((e = t) && DataView.prototype.isPrototypeOf(e)) ? (this._bodyArrayBuffer = v(t.buffer),
                    ...
                    this.text = function() {
                        ...
                        if (this._bodyArrayBuffer)
                            return Promise.resolve(function(t) {
                                for (var e = new Uint8Array(t), r = new Array(e.length), i = 0; i < e.length; i++)
    ...
    16977: t => {
        ...
        function h(t, e, r, i) {
            ...
            void 0 === o)
                o = s[e] = r,
                ++t._eventsCount;
            else if ("function" === typeof o ? o = s[e] = i ? [r, o] : [o, r] : i ? o.unshift(r) : o.push(r),
            (n = c(t)) > 0 && o.length > n && !o.warned) {
                o.warned = !0;
    ...
    8753: (t, e, r) => {
        ...
        T[a] = T[c] = T[x] = T[u] = T[C] = T[l] = T[p] = T[f] = T[g] = T[v] = T[m] = T[b] = T[E] = T[I] = T[O] = !1;
        ...
        var B, K, F = Array.prototype, Z = Function.prototype, W = Object.prototype, G = L["__core-js_shared__"], J = Z.toString, Q = W.hasOwnProperty, Y = function() {
            var t = /[^.]+$/.exec(G && G.keys && G.keys.IE_PROTO || "");
            return t ? "Symbol(src)_1." + t : ""
        }(), X = W.toString, tt = RegExp("^" + J.call(Q).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), et = M ? L.Buffer : void 0, rt = L.Symbol, it = L.Uint8Array, nt = W.propertyIsEnumerable, st = F.splice, ot = rt ? rt.toStringTag : void 0, at = Object.getOwnPropertySymbols, ct = et ? et.isBuffer : void 0, ht = (B = Object.keys,
        K = Object,
        function(t) {
            return B(K(t))
        }
        ), ut = zt(L, "DataView"), lt = zt(L, "Map"), pt = zt(L, "Promise"), ft = zt(L, "Set"), dt = zt(L, "WeakMap"), gt = zt(Object, "create"), vt = Ht(ut), yt = Ht(lt), mt = Ht(pt), wt = Ht(ft), _t = Ht(dt), bt = rt ? rt.prototype : void 0, Et = bt ? bt.valueOf : void 0;
        function It(t) {
            var e = -1
              , r = null == t ? 0 : t.length;
            for (this.clear(); ++e < r; ) {
        ...
        function Ct(t, e) {
            var r = Kt(t)
              ...
              , c = a.length;
            for (var h in t)
                !e && !Q.call(t, h) || o && ("length" == h || n && ("offset" == h || "parent" == h) || s && ("buffer" == h || "byteLength" == h || "byteOffset" == h) || Ut(h, c)) || a.push(h);
            return a
        }
        function Rt(t, e) {
            for (var r = t.length; r--; )
        ...
        function Nt(t, e, r, i, o) {
            return t === e || (null == t || null == e || !Jt(t) && !Jt(e) ? t !== t && e !== e : function(t, e, r, i, o, h) {
                ...
                if (O && !_)
                    return h || (h = new xt),
                    f || Qt(t) ? qt(t, e, r, i, o, h) : function(t, e, r, i, o, a, c) {
                        switch (r) {
                        case C:
                            if (t.byteLength != e.byteLength || t.byteOffset != e.byteOffset)
                                return !1;
                ...
                function(t, e, r, i, s, o) {
                    ...
                    for (; ++p < h; ) {
                        var y = t[f = c[p]]
                          , m = e[f];
                        if (i)
                            var w = a ? i(m, y, f, e, t, o) : i(y, m, f, t, e, o);
        ...
        function Lt(t) {
            ...
            for (var r in Object(t))
                Q.call(t, r) && "constructor" != r && e.push(r);
            return e
        }
        function qt(t, e, r, i, o, a) {
            ...
            a.set(e, t); ++p < h; ) {
                var g = t[p]
                  , v = e[p];
                if (i)
                    var y = c ? i(v, g, p, e, t, a) : i(g, v, p, t, e, a);
                if (void 0 !== y) {
                    if (y)
                        continue;
                    f = !1;
    ...
    85277: (t, e, r) => {
        ...
        function o(t) {
            ...
            g.child = function(r, n) {
                ...
                n = n || {},
                s && r.serializers && (n.serializers = r.serializers);
                ...
                function p(t) {
                    ...
                    this.error = h(t, r, "error"),
                    this.fatal = h(t, r, "fatal"),
                    this.warn = h(t, r, "warn"),
                    this.info = h(t, r, "info"),
                    this.debug = h(t, r, "debug"),
                    this.trace = h(t, r, "trace"),
                    a && (this.serializers = a,
                    this._serialize = l),
                    e && (this._logEvent = u([].concat(t._logEvent.bindings, r)))
                }
            ...
            function(t, e, r) {
                ...
                function() {
                    ...
                    for (var p = 0; p < h.length; p++)
                        h[p] = arguments[p];
                    if (t.serialize && !t.asObject && c(h, this._serialize, this.serializers, this._stdErrSerialize),
                    t.asObject ? s.call(l, function(t, e, r, n) {
                        t._serialize && c(r, t._serialize, t.serializers, t._stdErrSerialize);
                        const s = r.slice();
                        let a = s[0];
                        const h = {};
                        n && (h.time = n),
                        h.level = o.levels.values[e];
                        let u = 1 + (0 | t._childLevel);
                        if (u < 1 && (u = 1),
                        null !== a && "object" === typeof a) {
                            for (; u-- && "object" === typeof s[0]; )
                                Object.assign(h, s.shift());
                            a = s.length ? i(s.shift(), s) : void 0
                        } else
                            "string" === typeof a && (a = i(s.shift(), s));
                        return void 0 !== a && (h.msg = a),
                        h
                    }(this, r, h, a)) : s.apply(l, h),
                    t.transmit) {
